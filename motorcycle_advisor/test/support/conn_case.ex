defmodule MotorcycleAdvisorWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use MotorcycleAdvisorWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use MotorcycleAdvisorWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import MotorcycleAdvisorWeb.ConnCase
    end
  end
