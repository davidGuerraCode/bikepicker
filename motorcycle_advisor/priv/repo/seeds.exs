...
motorcycles = [
  # NAKED — beginner
  %{brand: "Honda", model: "CB190R", year: 2024, category: "naked",
    price_cop: 7_500_000, engine_cc: 184, power_hp: 17, weight_kg: 138,
    fuel_efficiency: Decimal.new("45.0"), experience_level: "beginner",
    use_case: "urban", image_url: "https://placehold.co/600x400?text=Honda+CB190R",
    description: "Naked urbana ideal para empezar, ligera y económica.",
    tags: ["económica", "ágil", "principiante"]},

  %{brand: "Yamaha", model: "FZ25", year: 2024, category: "naked",
    price_cop: 11_200_000, engine_cc: 249, power_hp: 21, weight_kg: 153,
    fuel_efficiency: Decimal.new("38.0"), experience_level: "intermediate",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Yamaha+FZ25",
    description: "Naked versátil con buen rendimiento en ciudad y carretera.",
    tags: ["ágil", "versátil", "tecnológica"]},

  %{brand: "KTM", model: "Duke 390", year: 2024, category: "naked",
    price_cop: 21_500_000, engine_cc: 373, power_hp: 44, weight_kg: 163,
    fuel_efficiency: Decimal.new("30.0"), experience_level: "advanced",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=KTM+Duke+390",
    description: "Naked agresiva con potencia y tecnología premium.",
    tags: ["potente", "tecnológica", "estilosa", "icónica"]},

  %{brand: "Bajaj", model: "Pulsar NS200", year: 2024, category: "naked",
    price_cop: 9_800_000, engine_cc: 199, power_hp: 24, weight_kg: 156,
    fuel_efficiency: Decimal.new("35.0"), experience_level: "intermediate",
    use_case: "urban", image_url: "https://placehold.co/600x400?text=Bajaj+NS200",
    description: "Naked accesible con buen desempeño urbano.",
    tags: ["económica", "potente", "ágil"]},

  # SPORT — intermediate/advanced
  %{brand: "Kawasaki", model: "Ninja 400", year: 2024, category: "sport",
    price_cop: 23_000_000, engine_cc: 399, power_hp: 45, weight_kg: 167,
    fuel_efficiency: Decimal.new("28.0"), experience_level: "intermediate",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Kawasaki+Ninja+400",
    description: "Sport accesible con rendimiento cercano al nivel de competición.",
    tags: ["deportiva", "potente", "estilosa"]},

  %{brand: "Honda", model: "CBR600RR", year: 2024, category: "sport",
    price_cop: 45_000_000, engine_cc: 599, power_hp: 117, weight_kg: 194,
    fuel_efficiency: Decimal.new("22.0"), experience_level: "advanced",
    use_case: "track", image_url: "https://placehold.co/600x400?text=Honda+CBR600RR",
    description: "Supersport pura, pensada para pista y riders expertos.",
    tags: ["deportiva", "potente", "icónica", "tecnológica"]},

  %{brand: "Yamaha", model: "R3", year: 2024, category: "sport",
    price_cop: 16_500_000, engine_cc: 321, power_hp: 42, weight_kg: 169,
    fuel_efficiency: Decimal.new("30.0"), experience_level: "beginner",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Yamaha+R3",
    description: "Deportiva de entrada ideal para riders que quieren estilo.",
    tags: ["deportiva", "estilosa", "principiante"]},

  %{brand: "Suzuki", model: "GSX-R750", year: 2024, category: "sport",
    price_cop: 38_000_000, engine_cc: 750, power_hp: 148, weight_kg: 203,
    fuel_efficiency: Decimal.new("20.0"), experience_level: "advanced",
    use_case: "track", image_url: "https://placehold.co/600x400?text=Suzuki+GSX-R750",
    description: "Supersport legendaria para riders de alto nivel.",
    tags: ["deportiva", "potente", "icónica"]},

  # ADVENTURE — all levels
  %{brand: "Honda", model: "CB500X", year: 2024, category: "adventure",
    price_cop: 20_000_000, engine_cc: 471, power_hp: 47, weight_kg: 197,
    fuel_efficiency: Decimal.new("27.0"), experience_level: "beginner",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Honda+CB500X",
    description: "Adventure accesible, cómoda en ciudad y carretera.",
    tags: ["versátil", "cómoda", "principiante"]},

  %{brand: "BMW", model: "F850GS", year: 2024, category: "adventure",
    price_cop: 55_000_000, engine_cc: 853, power_hp: 95, weight_kg: 220,
    fuel_efficiency: Decimal.new("22.0"), experience_level: "advanced",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=BMW+F850GS",
    description: "Adventure premium para viajes largos y cualquier terreno.",
    tags: ["premium", "potente", "tecnológica", "cómoda"]},

  %{brand: "Royal Enfield", model: "Himalayan 450", year: 2024, category: "adventure",
    price_cop: 18_500_000, engine_cc: 452, power_hp: 40, weight_kg: 196,
    fuel_efficiency: Decimal.new("30.0"), experience_level: "intermediate",
    use_case: "offroad", image_url: "https://placehold.co/600x400?text=RE+Himalayan+450",
    description: "Adventure accesible con capacidad off-road real.",
    tags: ["versátil", "offroad", "económica"]},

  %{brand: "KTM", model: "390 Adventure", year: 2024, category: "adventure",
    price_cop: 26_000_000, engine_cc: 373, power_hp: 44, weight_kg: 177,
    fuel_efficiency: Decimal.new("28.0"), experience_level: "intermediate",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=KTM+390+Adventure",
    description: "Adventure compacta con tecnología premium de KTM.",
    tags: ["tecnológica", "versátil", "estilosa"]},

  # CRUISER
  %{brand: "Honda", model: "Shadow 750", year: 2024, category: "cruiser",
    price_cop: 28_000_000, engine_cc: 745, power_hp: 45, weight_kg: 233,
    fuel_efficiency: Decimal.new("25.0"), experience_level: "intermediate",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=Honda+Shadow+750",
    description: "Cruiser clásica con motor en V de carácter suave.",
    tags: ["cómoda", "icónica", "estilosa"]},

  %{brand: "Harley-Davidson", model: "Iron 883", year: 2024, category: "cruiser",
    price_cop: 52_000_000, engine_cc: 883, power_hp: 51, weight_kg: 247,
    fuel_efficiency: Decimal.new("20.0"), experience_level: "advanced",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=Harley+Iron+883",
    description: "Cruiser icónica americana con carácter inconfundible.",
    tags: ["icónica", "estilosa", "premium"]},

  %{brand: "Kawasaki", model: "Vulcan S 650", year: 2024, category: "cruiser",
    price_cop: 22_000_000, engine_cc: 649, power_hp: 61, weight_kg: 228,
    fuel_efficiency: Decimal.new("24.0"), experience_level: "intermediate",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Kawasaki+Vulcan+S",
  ...
  %{brand: "Honda", model: "PCX 150", year: 2024, category: "scooter",
    price_cop: 8_200_000, engine_cc: 153, power_hp: 13, weight_kg: 130,
    fuel_efficiency: Decimal.new("50.0"), experience_level: "beginner",
    use_case: "urban", image_url: "https://placehold.co/600x400?text=Honda+PCX+150",
    description: "Scooter urbana eficiente y práctica para el día a día.",
    tags: ["económica", "práctica", "ágil", "principiante"]},

  %{brand: "Yamaha", model: "NMAX 155", year: 2024, category: "scooter",
    price_cop: 10_500_000, engine_cc: 155, power_hp: 15, weight_kg: 127,
    fuel_efficiency: Decimal.new("48.0"), experience_level: "beginner",
    use_case: "urban", image_url: "https://placehold.co/600x400?text=Yamaha+NMAX+155",
    description: "Scooter premium con tecnología y comodidad.",
    tags: ["económica", "tecnológica", "práctica", "principiante"]},

  %{brand: "Kymco", model: "AK 550", year: 2024, category: "scooter",
    price_cop: 19_000_000, engine_cc: 550, power_hp: 53, weight_kg: 218,
    fuel_efficiency: Decimal.new("30.0"), experience_level: "intermediate",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Kymco+AK+550",
    description: "Maxiscooter potente para ciudad y carretera.",
    tags: ["potente", "cómoda", "tecnológica"]},

  # TOURING
  %{brand: "BMW", model: "R 1250 RT", year: 2024, category: "touring",
    price_cop: 90_000_000, engine_cc: 1254, power_hp: 136, weight_kg: 279,
    fuel_efficiency: Decimal.new("18.0"), experience_level: "advanced",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=BMW+R1250RT",
    description: "Touring premium definitiva para viajes largos en máximo confort.",
    tags: ["premium", "cómoda", "tecnológica", "potente"]},

  %{brand: "Honda", model: "NT1100", year: 2024, category: "touring",
    price_cop: 42_000_000, engine_cc: 1084, power_hp: 102, weight_kg: 248,
    fuel_efficiency: Decimal.new("20.0"), experience_level: "advanced",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=Honda+NT1100",
    description: "Touring polivalente con ADN deportivo.",
    tags: ["cómoda", "versátil", "tecnológica"]},

  # OFFROAD
  %{brand: "KTM", model: "300 EXC TPI", year: 2024, category: "offroad",
    price_cop: 35_000_000, engine_cc: 293, power_hp: 50, weight_kg: 103,
    fuel_efficiency: Decimal.new("20.0"), experience_level: "advanced",
    use_case: "offroad", image_url: "https://placehold.co/600x400?text=KTM+300+EXC",
    description: "Enduro pura de competición para terrenos extremos.",
    tags: ["potente", "offroad", "deportiva"]},

  %{brand: "Honda", model: "CRF250F", year: 2024, category: "offroad",
    price_cop: 12_000_000, engine_cc: 249, power_hp: 21, weight_kg: 120,
    fuel_efficiency: Decimal.new("35.0"), experience_level: "beginner",
    use_case: "offroad", image_url: "https://placehold.co/600x400?text=Honda+CRF250F",
    description: "Enduro ligera para iniciarse en el off-road.",
    tags: ["ligera", "offroad", "principiante"]},

  %{brand: "Yamaha", model: "WR450F", year: 2024, category: "offroad",
    price_cop: 28_000_000, engine_cc: 449, power_hp: 57, weight_kg: 117,
    fuel_efficiency: Decimal.new("22.0"), experience_level: "advanced",
    use_case: "offroad", image_url: "https://placehold.co/600x400?text=Yamaha+WR450F",
    description: "Enduro de alto rendimiento con tecnología de pista.",
    tags: ["potente", "offroad", "deportiva", "tecnológica"]},

  # More for coverage
  %{brand: "Benelli", model: "TNT 302R", year: 2024, category: "sport",
    price_cop: 13_500_000, engine_cc: 300, power_hp: 38, weight_kg: 172,
    fuel_efficiency: Decimal.new("31.0"), experience_level: "beginner",
    use_case: "mixed", image_url: "https://placehold.co/600x400?text=Benelli+TNT+302R",
    description: "Deportiva accesible de buen diseño y equipamiento.",
    tags: ["estilosa", "deportiva", "principiante"]},

  %{brand: "Suzuki", model: "V-Strom 650", year: 2024, category: "adventure",
    price_cop: 29_000_000, engine_cc: 645, power_hp: 71, weight_kg: 213,
    fuel_efficiency: Decimal.new("24.0"), experience_level: "intermediate",
    use_case: "highway", image_url: "https://placehold.co/600x400?text=Suzuki+VStrom+650",
    description: "Adventure confiable y versátil para rutas largas.",
    tags: ["versátil", "cómoda", "económica"]},

  %{brand: "Royal Enfield", model: "Meteor 350", year: 2024, category: "cruiser",
    price_cop: 11_500_000, engine_cc: 349, power_hp: 20, weight_kg: 191,
    fuel_efficiency: Decimal.new("35.0"), experience_level: "beginner",
...
questions = [
  %{
    ...
    options: %{
      items: [
        ...
        %{value: "highway", label: "Carretera", icon: "🛣️", description: "Rutas, autopistas, viajes largos"},
  ...
  %{
    ...
    options: %{
      items: [
        %{value: "low", label: "Hasta $8 millones", icon: "💰", description: "Presupuesto ajustado"},
        %{value: "medium", label: "$8M – $20 millones", icon: "💵", description: "Rango medio"},
        %{value: "high", label: "Más de $20 millones", icon: "💎", description: "Sin límite de calidad"}
      ]
    },
    order: 2
  },
  %{
    ...
    options: %{
      items: [
        %{value: "beginner", label: "Principiante", icon: "🌱", description: "Poco o ningún tiempo en moto"},
        %{value: "intermediate", label: "Intermedio", icon: "⚡", description: "Algunos años de rodaje"},
  ...
  %{
    ...
    options: %{
      items: [
        %{value: "economy", label: "Economía", icon: "⛽", description: "Bajo consumo, buen precio"},
        %{value: "power", label: "Potencia", icon: "🔥", description: "Motor fuerte, buena aceleración"},
        %{value: "comfort", label: "Comodidad", icon: "🛋️", description: "Ligera, fácil de maniobrar"},
  ...
  %{
    ...
    options: %{
      items: [
        ...
        %{value: "adventure", label: "Adventure", icon: "🧭", description: "Para cualquier terreno"},
        %{value: "cruiser", label: "Cruiser", icon: "🤘", description: "Estilo americano, relajada"},
        ...
        %{value: "touring", label: "Touring", icon: "🗺️", description: "Viajes largos, máximo confort"}
      ]
    },
    order: 5
  }
